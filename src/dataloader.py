...
class TwitterDataloader(object):
  ...
  def __init__(self, filename, colnames, file_length, batch_size):
    ...
    self.df = pd.read_csv(filename, names=colnames, header=None, chunksize=batch_size)
...
if __name__ == '__main__':
  ...
  parser.add_argument('-cn', '--colnames', type=str, default=["r_pid", "r_uid", "r_t", "p_pid", "p_uid", "p_t", "c_pid", "c_uid", "c_t"], nargs='+')
