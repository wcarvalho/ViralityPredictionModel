...
class TwitterDataloader(object):
  ...
  def __init__(self, chunks, key, user_size, colnames, label_files, label_map, text_files, image_files, dummy_user_vector=False, shuffle=False, batch_size=1024, num_workers=4, max_label_files_open=10,
    max_hfpy_files_open=5):
