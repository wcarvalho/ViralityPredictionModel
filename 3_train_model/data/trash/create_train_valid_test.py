...
if __name__ == '__main__':
  ...
  nfiles = len(files)
  train_files = files[:int(nfiles*.7)]

  last_30_first = files[int(nfiles*.7):int(nfiles*.8)]
  last_30_second = files[int(nfiles*.8):int(nfiles*.9)]
  last_30_third = files[int(nfiles*.9):]
